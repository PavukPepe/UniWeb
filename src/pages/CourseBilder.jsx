...
function CourseBuilder() {
                ...
                return {
                  ...
                  steps: [
                    ...topic.steps,
                    {
                      ...
                      content: "",
                      type: "text", // Новый шаг по умолчанию "text"
                    },
                  ],
                };
              }
  ...
  const saveChanges = () => {
    ...
    if (editingItem.type === "block") {
      setBlocks(
        blocks.map((block) =>
          block.id === editingItem.id ? { ...block, title: editingItem.title } : block
        )
      );
                ...
                return {
                  ...
                  steps: topic.steps.map((step) =>
                    step.id === editingStep.id
                      ? { ...step, title: editingStep.title, content: editingStep.content, type: editingStep.type }
                      : step
                  ),
                };
              }
